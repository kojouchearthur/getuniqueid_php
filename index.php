...
#Example 1 to use the getuniqueid() function 
 $userregnum = getuniqueid() //calls the function without any parameters, hence the function will return a result (a unique id that is 4 in length, all numbers not alphabets)
 
#Example 2 to use the getuniqueid() function
 $regnum = getuniqueid(4,3) //function will return an alphanumeric id that is 7 in length (4 numbers, 3 alphabets)
